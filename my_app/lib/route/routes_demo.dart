...
final Map<String, WidgetBuilder> routes = {
  ...
  "/registerFirst": (context,{arguments})=> RegisterFistScreen(arguments: arguments),
  "/registerSecond": (context,{arguments})=> RegisterSecondScreen(arguments: arguments),
  "/registerThird": (context,{arguments})=> RegisterThirdScreen(arguments: arguments),
};
